...
-XX:SharedArchiveFile=$API_BUILD_DIR/configure-support/classes.jsa -Xshare:auto \
...
--module-path $API_BUILD_DIR/buildtools/interim_langtools_modules \
...
-d $API_BUILD_DIR/images/docs/api \
...
-tagletpath $API_BUILD_DIR/buildtools/jdk_tools_classes \
--module-source-path "$API_BUILD_DIR/support/gensrc/*:$API_BUILD_DIR/src/*/linux/classes:$API_BUILD_DIR/src/*/unix/classes:$API_BUILD_DIR/src/*/share/classes" \
--module java.base \
-Xdoclint:all, -Xdoclint/package:-org.w3c.* \
...
-overview $API_BUILD_DIR/support/docs/JDK_API-overview.html \
